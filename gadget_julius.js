  ...
  rJS(window)
    ...
    .declareMethod('render', function (my_option_dict) {
      ...
      props.julius = new Julius({
        pathToHmmdefs: 'project/julius_test/voxforge/hmmdefs',
        pathToTiedlist: 'project/julius_test/voxforge/tiedlist',
        pathToWorker: 'worker.js',
        pathToDfa: 'project/julius_test/voxforge/sample.dfa',
        pathToDict: 'project/julius_test/voxforge/sample.dict',
        log: true,
        // all options: http://julius.osdn.jp/juliusbook/en/
        zc: 90
      });
